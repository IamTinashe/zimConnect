  ...
  <div class="w-100 register">
    <div class="w-100 banner">
      <img
        ...
        src="/images/living-room-interior-with-blue-velvet-armchair-cabinet.jpg"
        alt="Living room interior with blue velvet armchair cabinet"
      />
    </div>
    <div class="container-fluid bgColor-gray-10 pb-5">
      <div class="container">
        <div
          class="row justify-content-md-center pt-5 pt-lg-0 hero"
          v-if="!created"
        >
          <div class="col-sm-12 col-md-10 col-lg-8 middle-align">
            <h2 class="text-center Color-gray-80 subhead mt-5">Register</h2>
            <small class="text-center Color-error" v-if="error.length > 0"
              >{{ error }}
            </small>
            <form class="form pt-3" @submit.prevent="register()">
              <label class="ml-2 Color-gray-80 feature-paragraph" for="fullname"
                >Fullname*</label
              >
              <input
                ...
                type="text"
                id="fullname"
                class="form-input w-100 px-3 py-2 py-lg-3 mb-4"
                required
              />

              <label class="ml-2 Color-gray-80 feature-paragraph" for="username"
                >Username*</label
              >
              <input
              ...
              <label class="ml-2 Color-gray-80 feature-paragraph" for="email"
                >Email Address*</label
              >
              <input
                v-model="user.email"
              ...
              <label class="ml-2 Color-gray-80 feature-paragraph" for="company"
                >Company*</label
              >
              <input
              ...
              <label class="ml-2 Color-gray-80 feature-paragraph" for="password"
                >Password*</label
              >
              <input
        ...
        <div class="row justify-content-md-center pt-5 pt-lg-0 hero" v-else>
          <div class="col-sm-12 col-md-10 col-lg-8 middle-align">
            <h2 class="text-center Color-gray-80 group-header mt-5">
              Your Account was successfully created! We have sent a confirmation
              email to {{ user.email }}
            </h2>
          </div>
        </div>
          ...
          if (this.confirmPassword()) {
            if (this.validateUsername(this.user.username)) {
              try {
                ...
                this.returnedUser = await users.addUser(this.user);
                this.created = true;
              } catch (error) {
              ...
              this.error =
                "Please remove any special characters in your username";
            }
          } else {
            this.error =
